 ...
 * @author Dominic Gunn
 */
public class LiquibaseAutoConfigurationTest {
    ...
    public void overrideDataSource() {
        this.contextRunner.withUserConfiguration(EmbeddedDataSourceConfiguration.class)
                .withPropertyValues("spring.liquibase.url:jdbc:h2:mem:liquibase")
                .run(assertLiquibase((liquibase) -> {
    ...
    public void overrideUser() {
        this.contextRunner.withUserConfiguration(EmbeddedDataSourceConfiguration.class)
                .withPropertyValues("spring.datasource.url:jdbc:h2:mem:normal",
    ...
    static class LiquibaseDataSourceConfiguration {
        ...
        public DataSource normalDataSource() {
            return DataSourceBuilder.create().url("jdbc:h2:mem:normal").username("sa")
                    .build();
        }
        ...
        public DataSource liquibaseDataSource() {
            return DataSourceBuilder.create().url("jdbc:h2:mem:liquibasetest")
                    .username("sa").build();
        }
